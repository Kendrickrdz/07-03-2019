...
constructor (){
  ...
  this.colorR2 = random(0,255);
	this.colorG2= random(0,255);
	this.colorB2= random(0,255);
}
	mostrar(){
    stroke(this.colorR2, this.colorG2, this.colorB2);
		fill(this.colorR, this.colorG, this.colorB, 130);
